    ...
    <main className="flex items-center min-h-screen relative bg-cover bg-[url('/assets/bg-explosion.png')]">
      ...
      <div className="flex flex-col gap-3 z-[10] pl-40 pt-20">
        ...
        <p className="text-[16px] text-gray-200 md:text-gray-400 mb-10 md:pb-2 max-w-[400px]">
          ...
          dolores eos debitis, voluptates quo amet cupiditate? Voluptas
          consequuntur itaque quibusdam asperiores fuga vero corporis possimus
          nemo. Libero repudiandae dolorem vel.
        </p>
