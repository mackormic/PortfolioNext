...
const ServiceSlider = () => {
  return (
    <div className="absolute bottom-0 md:bottom-40 right-20 md:right-30 w-[60%] md:w-[55%]">
      <Swiper
        breakpoints={{
          340: {
            slidesPerView: 1,
      ...
      >
        {ServiceData.map((item) => (
          <SwiperSlide key={item.title}>
            <div className="cursor-pointer flex flex-col gap-6 mb-10 group relative text-white shadow-lg rounded-md px-6 py-8 h-[300px] w-[250px] overflow-hidden">
              <div
